...
wlan_2g_ssid="ZHANG"                              # 2G 无线名称
wlan_5g_ssid="ZHANG_5G"                           # 5G 无线名称
wlan_guest_2g_ssid="ZHANG_Guset"                  # 2G 访客无线名称
wlan_guest_5g_ssid="ZHANG_Guest_5G"               # 5G 访客无线名称
wlan_2g_psk="7418520963"                            # 2G WIFI密码最少8位 空白为不设置
wlan_5g_psk="7418520963"                            # 5G WIFI密码最少8位 空白为不设置
